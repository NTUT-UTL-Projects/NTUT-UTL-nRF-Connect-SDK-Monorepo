...
int z_impl_spi_device_init(const struct device *const spi)
{
    int err = 0;
...
int z_impl_spi_cs_init(const struct gpio_dt_spec *const cs)
{
...
int z_impl_spi_cs_select(const struct gpio_dt_spec *const cs, const bool value)
{
