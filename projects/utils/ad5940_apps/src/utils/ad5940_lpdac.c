...
extern inline BoolFlag AD5940_LPDACData12Bit_is_greater(uint16_t DacData12Bit, uint16_t DacData6Bit);

extern inline uint16_t AD5940_volts_to_LPDACData6Bit(float volts);
extern inline uint16_t AD5940_volts_to_LPDACData12Bit(float volts, uint16_t DacData6Bit);

extern inline uint32_t AD5940_LPDACDataBits_to_LPDACDAT(uint16_t DacData12Bit, uint16_t DacData6Bit);
...
extern inline float AD5940_DacData12Bit_to_volts(uint16_t DacData12Bit, BoolFlag LPDACData12Bit_is_greater);
