...
#include "ad5940.h"
    ...
    /**
     * Clears all configuration settings related to GPIO and interrupt (INT)
     * flags.
     *
     * @note
    ...
    /**
     * Retrieves the interrupt (INT) enable status based on the specified AGPIO
     * configuration.
     *
     * @note
     * Refer to pages 112 and 123 of the datasheet for more details.
     * This function maps the relationship between GPIO and interrupt
     * controllers (INT).
     *
     * @param FuncSet       @see AGPIOCfg_Type.FuncSet.
     * @param AFEINTC_0_En  Pointer to a `BoolFlag` to store the enable status
     * of `AFEINTC_0`.
     * @param AFEINTC_1_En  Pointer to a `BoolFlag` to store the enable status
     * of `AFEINTC_1`.
     */
    ...
    /**
     * Configures the interrupt controller (INTC) settings based on the
     * specified AGPIO configuration.
     *
     * @note
     ...
     * @param AFEIntSrc     Interrupt source to configure. Refer to @ref
     * AFEINTC_SRC_Const for available interrupt source flags.
     */
