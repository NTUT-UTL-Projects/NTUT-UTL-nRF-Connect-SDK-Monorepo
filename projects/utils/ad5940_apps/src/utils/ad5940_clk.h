...
#include "ad5940.h"
    ...
    typedef struct
    {
        ...
        float AdcClkFreq; // @see ADC clock frequency value (in Hz). This term
                          // is referenced throughout the datasheet.
        float SysClkFreq; // @see system clock frequency value (in Hz). This
                          // term is referenced throughout the datasheet.
     ...
     * access date: 2025-08-11 11:07
     *
     * Refer to HIGH SPEED DAC CIRCUITS, p. 43 of the datasheet.
     *
     * Refer to AVOIDING INCOHERENCY ERRORS BETWEEN EXCITATION AND MEASUREMENT
     * FREQUENCIES DURING IMPEDANCE MEASUREMENTS, p. 45 of the datasheet.
     *
     * Refer to HIGH PERFORMANCE ADC CIRCUIT, p. 54 of the datasheet.
     *
     * Refer to Table 41. Digital Filter Settings to Support Simultaneous 50
     * Hz/60 Hz Mains Rejection, p. 57 of the datasheet.
     *
     ...
     *
     * @return AD5940Err    Error code indicating the success or failure of the
     * operation.
     */
